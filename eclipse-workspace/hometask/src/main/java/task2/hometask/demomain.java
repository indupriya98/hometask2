...
public class demomain {
	...
	public static void main(String[] args) {
		...
		g[0]=new assorted("kovapuri",100);
		g[1]=new assorted("katli   ",50);
		g[2]=new assorted("kalakand",30);
		g[3]=new choco("rocher",20);
		g[4]=new choco("bounty",45);
        g[5]=new choco("kitkat",30);
        do {
